...
let questions = [
    ...
    {
        question : "Do you need my services ?",
        options : {
            a : "no",
            b : "yes",
        },
        correctAnswer: "b",
        correctResponse: "Super! You can contact through the contact page",
        incorrectResponse : "Have fun discovering my portfolio <a href='index.html'> Here</a> and feel free to contact me later if you need my services !"
    }
];
